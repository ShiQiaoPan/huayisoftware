...
- (void)controlsInit
{
    ...
    [_OkButton setTitleColor:COLOR_RGB(119, 66, 32, 1) forState:UIControlStateNormal];
...
- (void)logoInit
{
    ...
    _logoView.backgroundColor = COLOR_RGB(217, 254, 254, 1);
    //_logoView.alpha = 0.9;
...
-(void) drawRight
{
    ...
    //勾的起点
    [path moveToPoint:CGPointMake(x -5 , y - 6)];
    //勾的最底端
